        ...
        <div className={styles.container}>
            <div className={styles.content}>
                ...
                <section className={styles.section}>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            단, 서비스 품질 향상을 위해 발췌 문장의 텍스트 정제 분석에
                            Anthropic, PBC의 AI 도구(Claude)가 활용될 수 있으며, 이는 출처 표시 제거·불필요한 문자열 정리 등
                            텍스트 처리 오류 개선 목적에 한합니다.
                        ...
                        <li>
                            타인의 저작권을 침해하는 콘텐츠 게시에 대한 책임은 이용자에게 있으며,
                ...
                <section className={styles.section}>
                    <h2>제10조 (후원)</h2>
                    <p>
                        서비스는 이용자가 자발적으로 운영자에게 소액을 후원할 수 있는 기능을 제공합니다.
                        후원은 어떠한 반대급부나 추가 혜택 없이 이루어지는 자발적 기부이며,
                        후원금은 서버 운영비 등 서비스 유지에 한하여 사용됩니다.
                        본 서비스는 비영리로 운영되며, 후원 기능은 상업적 서비스 제공을 목적으로 하지 않습니다.
                    </p>
                </section>

                {/* 제11조 개인정보 보호 (기존 제10조) */}
                <section className={styles.section}>
                    <h2>제11조 (개인정보 보호)</h2>
                    <p>
